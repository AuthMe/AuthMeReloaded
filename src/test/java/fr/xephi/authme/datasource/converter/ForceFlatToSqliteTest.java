...
public class ForceFlatToSqliteTest {
    ...
    public void shouldConvertToSqlite() {
        ...
        assertThat(auths, hasItem(hasAuthBasicData("bobby", null, null, "123.45.67.89")));
        assertThat(auths, hasItem(hasAuthLocation(1.05, 2.1, 4.2, "world", 0, 0)));
        assertThat(auths, hasItem(hasAuthBasicData("user", null, "user@example.org", "34.56.78.90")));
        assertThat(auths, hasItem(hasAuthLocation(124.1, 76.3, -127.8, "nether", 0, 0)));
        assertThat(auths, hasItem(hasAuthBasicData("eightfields", null, null, "6.6.6.66")));
