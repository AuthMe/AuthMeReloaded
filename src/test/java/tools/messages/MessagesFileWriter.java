...
public final class MessagesFileWriter {
    ...
    private void performWrite() {
        ...
        ConfigurationData configurationData = MessageUpdater.createConfigurationData();
        YamlFileResource resource = new MigraterYamlFileResource(file);
        SettingsManager settingsManager = SettingsManagerBuilder.withResource(resource)
        ...
        createPropertyResourceWithCommentEntries(resource.createReader(), configurationData);
     ...
     * todo lj .
     */
    private void createPropertyResourceWithCommentEntries(PropertyReader reader, ConfigurationData configurationData) {
        for (Property<?> property : configurationData.getProperties()) {
            ...
            if (text == null) {
                configurationData.setValue(
                    (Property<String>) property, COMMENT_MARKER + defaultFile.getString(property.getPath()));
            }
        }
    }
