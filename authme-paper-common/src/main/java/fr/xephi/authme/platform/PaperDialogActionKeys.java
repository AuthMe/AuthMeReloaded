...
public final class PaperDialogActionKeys {
    ...
    public static final Key PRE_JOIN_LOGIN_RECOVERY = Key.key("authme:prejoin-login/recovery");
    public static final Key PRE_JOIN_RECOVERY_SUBMIT = Key.key("authme:prejoin-recovery/submit");
    public static final Key PRE_JOIN_RECOVERY_CANCEL = Key.key("authme:prejoin-recovery/cancel");
